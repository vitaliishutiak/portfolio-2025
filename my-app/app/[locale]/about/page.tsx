...
export default function AboutPage() {
  ...
  const skills = [
    ...
    {
      title: t("skills.animation"),
      description: t("skills.animationDesc"),
      color: "#9C27B0",
    },
  ];

  const achievements = [
    { label: t("achievements.projects"), value: "10+", color: "#4CAF50" },
    { label: t("achievements.clients"), value: "10+", color: "#2196F3" },
    { label: t("achievements.years"), value: "2+", color: "#FF9800" },
    { label: t("achievements.technologies"), value: "5+", color: "#9C27B0" },
  ];
